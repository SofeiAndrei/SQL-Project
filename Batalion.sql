...
insert into Regiune values(incrementare_cod_regiune.nextval,'Peninsula Balcanic?','România+Bulgaria');
...
----------------CERERI------------------
--11.
--1.S? se afi?eze, pentru solda?ii sta?iona?i în regiunea Europa de Vest ?i care au litera 'o' în nume sau în prenume, id-ul soldatului, numele, prenumele, 
--data primului salariu(ultima zi din luna în care s-a înrolat),câte zile a fost activ în for?ele armate pân? la terminarea r?zboiului(diferen?a dintre ziua sfâr?itului r?zboiului 02.09.1945 ?i data înrol?rii)
--?i dac? este ofi?er(maior,capitan,locotenent),subofiter(prim sergent, sergent) sau soldat (caporal, soldat prima clasa, soldat).
--S? se ordoneze cresc?tor valorile dup? lungimea numelui ?i în caz de egalitate dup? lungimea prenumelui.
...
--pentru solda?ii care au ca superior direct un soldat sta?ionat într-o regiune în care inamicul principal este Italia ?i care au salariul mai mic decât media salariilor rangurilor.
...
--S? se ordoneze valorile descresc?tor dup? num?rul de subordona?i direc?i ?i în caz de egalitate cresc?tor dup? codul soldatului.
...
--num?rul plutonului ?i salariul pentru solda?ii care au un salariu mai mare decât media salariilor solda?ilor din plutonul lor.
...
--12.
--1.Trece?i ora?ele din Singapore, Indonezia ?i Belgia ca fiind într-o zon? f?r? conflict.
Update Oras
